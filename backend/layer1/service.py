...
except ImportError:  # Optional decoder must not make unrelated API routes unavailable.
    gnewsdecoder = None
...
def _decode_google_news_url(url: str) -> str:
    if gnewsdecoder is None:
        raise RuntimeError("Google News URL decoding is unavailable in this environment")
...
def _validate_for_delivery(package: ResearchPackage) -> ResearchPackage:
    ...
    """
    from backend.layer2.services.validation import LOCAL_TYPES, REQUIRED_FIELDS, validate_objects
