...
import backend.layer3.blueprint_assembler_service.assembler as assembler
import backend.layer3.world_builder_service.world_builder as world_builder
from backend.main import app as layer2_app
from backend.layer3.world_builder_service.contracts import (
    CharacterDraft,
    EmotionState,
    EntityMapDraft,
    GenerationPayload,
...
FIXTURE_CONTEXT = Path(__file__).resolve().parents[3] / "docs" / "prds" / "fixture-topic-context.json"
