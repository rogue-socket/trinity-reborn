...
import backend.layer3.orchestrator_service.main as orchestrator_main
from backend.layer3.orchestrator_service.contracts import RunTopicRequest
...
def test_demo_mode_defaults_narrate_when_omitted(monkeypatch) -> None:
    ...
    def fake_run_topic(topic_id, character_ids, languages, narrate):
        ...
        from backend.layer3.orchestrator_service.contracts import RunReport
